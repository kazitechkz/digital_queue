...
class CreateOrganizationCase(BaseUseCase[OrganizationWithRelationsDTO]):
    ...
    async def execute(
        self, dto: OrganizationCDTO, file: Optional[UploadFile] = None
    ) -> OrganizationWithRelationsDTO:
    ...
    async def transform(self, dto: OrganizationCDTO, file: FileModel):
        dto.file_id = file.id
        return dto
