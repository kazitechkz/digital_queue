...
class VerifiedUserFilter(BasePaginationFilter[VerifiedUserModel]):
    def __init__(
        self,
        ...
        search: Optional[str] = AppQueryConstants.StandardOptionalSearchQuery(
            description="Уникальный поиск по идентификатору, ИИН, Описанию, Ответу, Верифицировавшему"
        ),
