...
class CreateOrderDTO(BaseModel):
    ...
    dogovor:DTOConstant.StandardNullableVarcharField(description="Договор юр лица получаемая из SAP")
    organization_id:DTOConstant.StandardNullableIntegerField(description="Идентификатор компании")
