...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "quan_t",
            sa.Float(),
            sa.Computed("(quan / 1000.0)::DOUBLE PRECISION", persisted=True),
            nullable=False,
        ),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            "quan_left",
            sa.Integer(),
            sa.Computed("quan - quan_booked - quan_released", persisted=True),
            nullable=False,
        ),
    )
    op.add_column(
        ...
        sa.Column(
            ...
            sa.Float(),
            sa.Computed(
                "(quan - quan_booked - quan_released) / 1000.0", persisted=True
            ),
            nullable=False,
        ),
    )
